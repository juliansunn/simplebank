...
func (processor *RedisTaskProcessor) ProcessTaskSendVerifyEmail(ctx context.Context, task *asynq.Task) error {
	...
	content := fmt.Sprintf(`Hello %s,<br/>please verify your email by clicking here: <a href=%s>click here</a> to verify your email address.<br/>`, user.FullName, verifyUrl)
